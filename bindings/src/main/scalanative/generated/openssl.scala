...
object structs:
  ...
  */
  ...
  /**
   * [bindgen] header: /Users/velvetbaldmime/Library/Caches/sbt-vcpkg/vcpkg/packages/openssl_arm64-osx/include/openssl/rand.h
  */
  opaque type RAND_METHOD = CStruct6[CFuncPtr2[Ptr[Byte], CInt, CInt], CFuncPtr2[Ptr[CUnsignedChar], CInt, CInt], CFuncPtr0[Unit], CFuncPtr3[Ptr[Byte], CInt, Double, CInt], CFuncPtr2[Ptr[CUnsignedChar], CInt, CInt], CFuncPtr0[CInt]]
  object RAND_METHOD:
    given _tag: Tag[RAND_METHOD] = Tag.materializeCStruct6Tag[CFuncPtr2[Ptr[Byte], CInt, CInt], CFuncPtr2[Ptr[CUnsignedChar], CInt, CInt], CFuncPtr0[Unit], CFuncPtr3[Ptr[Byte], CInt, Double, CInt], CFuncPtr2[Ptr[CUnsignedChar], CInt, CInt], CFuncPtr0[CInt]]
    def apply()(using Zone): Ptr[RAND_METHOD] = scala.scalanative.unsafe.alloc[RAND_METHOD](1)
    def apply(seed : CFuncPtr2[Ptr[Byte], CInt, CInt], bytes : CFuncPtr2[Ptr[CUnsignedChar], CInt, CInt], cleanup : CFuncPtr0[Unit], add : CFuncPtr3[Ptr[Byte], CInt, Double, CInt], pseudorand : CFuncPtr2[Ptr[CUnsignedChar], CInt, CInt], status : CFuncPtr0[CInt])(using Zone): Ptr[RAND_METHOD] = 
      val ____ptr = apply()
      (!____ptr).seed = seed
      (!____ptr).bytes = bytes
      (!____ptr).cleanup = cleanup
      (!____ptr).add = add
      (!____ptr).pseudorand = pseudorand
      (!____ptr).status = status
      ____ptr
    extension (struct: RAND_METHOD)
      def seed : CFuncPtr2[Ptr[Byte], CInt, CInt] = struct._1
      def seed_=(value: CFuncPtr2[Ptr[Byte], CInt, CInt]): Unit = !struct.at1 = value
      def bytes : CFuncPtr2[Ptr[CUnsignedChar], CInt, CInt] = struct._2
      def bytes_=(value: CFuncPtr2[Ptr[CUnsignedChar], CInt, CInt]): Unit = !struct.at2 = value
      def cleanup : CFuncPtr0[Unit] = struct._3
      def cleanup_=(value: CFuncPtr0[Unit]): Unit = !struct.at3 = value
      def add : CFuncPtr3[Ptr[Byte], CInt, Double, CInt] = struct._4
      def add_=(value: CFuncPtr3[Ptr[Byte], CInt, Double, CInt]): Unit = !struct.at4 = value
      def pseudorand : CFuncPtr2[Ptr[CUnsignedChar], CInt, CInt] = struct._5
      def pseudorand_=(value: CFuncPtr2[Ptr[CUnsignedChar], CInt, CInt]): Unit = !struct.at5 = value
      def status : CFuncPtr0[CInt] = struct._6
      def status_=(value: CFuncPtr0[CInt]): Unit = !struct.at6 = value
  ...
  */
   ...
   * [bindgen] header: /Users/velvetbaldmime/Library/Caches/sbt-vcpkg/vcpkg/packages/openssl_arm64-osx/include/openssl/rand.h
  */
  opaque type rand_meth_st = CStruct6[CFuncPtr2[Ptr[Byte], CInt, CInt], CFuncPtr2[Ptr[CUnsignedChar], CInt, CInt], CFuncPtr0[Unit], CFuncPtr3[Ptr[Byte], CInt, Double, CInt], CFuncPtr2[Ptr[CUnsignedChar], CInt, CInt], CFuncPtr0[CInt]]
  object rand_meth_st:
    given _tag: Tag[rand_meth_st] = Tag.materializeCStruct6Tag[CFuncPtr2[Ptr[Byte], CInt, CInt], CFuncPtr2[Ptr[CUnsignedChar], CInt, CInt], CFuncPtr0[Unit], CFuncPtr3[Ptr[Byte], CInt, Double, CInt], CFuncPtr2[Ptr[CUnsignedChar], CInt, CInt], CFuncPtr0[CInt]]
    def apply()(using Zone): Ptr[rand_meth_st] = scala.scalanative.unsafe.alloc[rand_meth_st](1)
    def apply(seed : CFuncPtr2[Ptr[Byte], CInt, CInt], bytes : CFuncPtr2[Ptr[CUnsignedChar], CInt, CInt], cleanup : CFuncPtr0[Unit], add : CFuncPtr3[Ptr[Byte], CInt, Double, CInt], pseudorand : CFuncPtr2[Ptr[CUnsignedChar], CInt, CInt], status : CFuncPtr0[CInt])(using Zone): Ptr[rand_meth_st] = 
      val ____ptr = apply()
      (!____ptr).seed = seed
      (!____ptr).bytes = bytes
      (!____ptr).cleanup = cleanup
...
private[openssl] object extern_functions:
  ...
  */
   ...
   * [bindgen] header: /Users/velvetbaldmime/Library/Caches/sbt-vcpkg/vcpkg/packages/openssl_arm64-osx/include/openssl/rand.h
  */
  def RAND_OpenSSL(): Ptr[RAND_METHOD] = extern

  /**
   * [bindgen] header: /Users/velvetbaldmime/Library/Caches/sbt-vcpkg/vcpkg/packages/openssl_arm64-osx/include/openssl/rand.h
  */
  def RAND_add(buf : Ptr[Byte], num : CInt, randomness : Double): Unit = extern
  ...
  */
   ...
   * [bindgen] header: /Users/velvetbaldmime/Library/Caches/sbt-vcpkg/vcpkg/packages/openssl_arm64-osx/include/openssl/rand.h
  */
  def RAND_bytes_ex(ctx : Ptr[OSSL_LIB_CTX], buf : Ptr[CUnsignedChar], num : size_t, strength : CUnsignedInt): CInt = extern

  /**
   * [bindgen] header: /Users/velvetbaldmime/Library/Caches/sbt-vcpkg/vcpkg/packages/openssl_arm64-osx/include/openssl/rand.h
  */
  def RAND_file_name(file : CString, num : size_t): CString = extern

  /**
   * [bindgen] header: /Users/velvetbaldmime/Library/Caches/sbt-vcpkg/vcpkg/packages/openssl_arm64-osx/include/openssl/rand.h
  */
  def RAND_get0_primary(ctx : Ptr[OSSL_LIB_CTX]): Ptr[EVP_RAND_CTX] = extern

  /**
   * [bindgen] header: /Users/velvetbaldmime/Library/Caches/sbt-vcpkg/vcpkg/packages/openssl_arm64-osx/include/openssl/rand.h
  */
  def RAND_get0_private(ctx : Ptr[OSSL_LIB_CTX]): Ptr[EVP_RAND_CTX] = extern

  /**
   * [bindgen] header: /Users/velvetbaldmime/Library/Caches/sbt-vcpkg/vcpkg/packages/openssl_arm64-osx/include/openssl/rand.h
  */
  def RAND_get0_public(ctx : Ptr[OSSL_LIB_CTX]): Ptr[EVP_RAND_CTX] = extern

  /**
   * [bindgen] header: /Users/velvetbaldmime/Library/Caches/sbt-vcpkg/vcpkg/packages/openssl_arm64-osx/include/openssl/rand.h
  */
  def RAND_get_rand_method(): Ptr[RAND_METHOD] = extern

  /**
   * [bindgen] header: /Users/velvetbaldmime/Library/Caches/sbt-vcpkg/vcpkg/packages/openssl_arm64-osx/include/openssl/rand.h
  */
  def RAND_keep_random_devices_open(keep : CInt): Unit = extern

  /**
   * [bindgen] header: /Users/velvetbaldmime/Library/Caches/sbt-vcpkg/vcpkg/packages/openssl_arm64-osx/include/openssl/rand.h
  */
  def RAND_load_file(file : CString, max_bytes : CLongInt): CInt = extern

  /**
   * [bindgen] header: /Users/velvetbaldmime/Library/Caches/sbt-vcpkg/vcpkg/packages/openssl_arm64-osx/include/openssl/rand.h
  */
  def RAND_poll(): CInt = extern

  /**
   * [bindgen] header: /Users/velvetbaldmime/Library/Caches/sbt-vcpkg/vcpkg/packages/openssl_arm64-osx/include/openssl/rand.h
  */
  def RAND_priv_bytes(buf : Ptr[CUnsignedChar], num : CInt): CInt = extern

  /**
   * [bindgen] header: /Users/velvetbaldmime/Library/Caches/sbt-vcpkg/vcpkg/packages/openssl_arm64-osx/include/openssl/rand.h
  */
  def RAND_priv_bytes_ex(ctx : Ptr[OSSL_LIB_CTX], buf : Ptr[CUnsignedChar], num : size_t, strength : CUnsignedInt): CInt = extern

  /**
   * [bindgen] header: /Users/velvetbaldmime/Library/Caches/sbt-vcpkg/vcpkg/packages/openssl_arm64-osx/include/openssl/rand.h
  */
  def RAND_pseudo_bytes(buf : Ptr[CUnsignedChar], num : CInt): CInt = extern

  /**
   * [bindgen] header: /Users/velvetbaldmime/Library/Caches/sbt-vcpkg/vcpkg/packages/openssl_arm64-osx/include/openssl/rand.h
  */
  def RAND_seed(buf : Ptr[Byte], num : CInt): Unit = extern

  /**
   * [bindgen] header: /Users/velvetbaldmime/Library/Caches/sbt-vcpkg/vcpkg/packages/openssl_arm64-osx/include/openssl/rand.h
  */
  def RAND_set0_private(ctx : Ptr[OSSL_LIB_CTX], rand : Ptr[EVP_RAND_CTX]): CInt = extern

  /**
   * [bindgen] header: /Users/velvetbaldmime/Library/Caches/sbt-vcpkg/vcpkg/packages/openssl_arm64-osx/include/openssl/rand.h
  */
  def RAND_set0_public(ctx : Ptr[OSSL_LIB_CTX], rand : Ptr[EVP_RAND_CTX]): CInt = extern

  /**
   * [bindgen] header: /Users/velvetbaldmime/Library/Caches/sbt-vcpkg/vcpkg/packages/openssl_arm64-osx/include/openssl/rand.h
  */
  def RAND_set_DRBG_type(ctx : Ptr[OSSL_LIB_CTX], drbg : CString, propq : CString, cipher : CString, digest : CString): CInt = extern

  /**
   * [bindgen] header: /Users/velvetbaldmime/Library/Caches/sbt-vcpkg/vcpkg/packages/openssl_arm64-osx/include/openssl/rand.h
  */
  def RAND_set_rand_engine(engine : Ptr[ENGINE]): CInt = extern

  /**
   * [bindgen] header: /Users/velvetbaldmime/Library/Caches/sbt-vcpkg/vcpkg/packages/openssl_arm64-osx/include/openssl/rand.h
  */
  def RAND_set_rand_method(meth : Ptr[RAND_METHOD]): CInt = extern

  /**
   * [bindgen] header: /Users/velvetbaldmime/Library/Caches/sbt-vcpkg/vcpkg/packages/openssl_arm64-osx/include/openssl/rand.h
  */
  def RAND_set_seed_source_type(ctx : Ptr[OSSL_LIB_CTX], seed : CString, propq : CString): CInt = extern

  /**
   * [bindgen] header: /Users/velvetbaldmime/Library/Caches/sbt-vcpkg/vcpkg/packages/openssl_arm64-osx/include/openssl/rand.h
  */
  def RAND_status(): CInt = extern

  /**
   * [bindgen] header: /Users/velvetbaldmime/Library/Caches/sbt-vcpkg/vcpkg/packages/openssl_arm64-osx/include/openssl/rand.h
  */
  def RAND_write_file(file : CString): CInt = extern
...
object all:
  ...
  export _root_.openssl.functions.RAND_OpenSSL
  export _root_.openssl.functions.RAND_add
  export _root_.openssl.functions.RAND_bytes
  export _root_.openssl.functions.RAND_bytes_ex
  export _root_.openssl.functions.RAND_file_name
  export _root_.openssl.functions.RAND_get0_primary
  export _root_.openssl.functions.RAND_get0_private
  export _root_.openssl.functions.RAND_get0_public
  export _root_.openssl.functions.RAND_get_rand_method
  export _root_.openssl.functions.RAND_keep_random_devices_open
  export _root_.openssl.functions.RAND_load_file
  export _root_.openssl.functions.RAND_poll
  export _root_.openssl.functions.RAND_priv_bytes
  export _root_.openssl.functions.RAND_priv_bytes_ex
  export _root_.openssl.functions.RAND_pseudo_bytes
  export _root_.openssl.functions.RAND_seed
  export _root_.openssl.functions.RAND_set0_private
  export _root_.openssl.functions.RAND_set0_public
  export _root_.openssl.functions.RAND_set_DRBG_type
  export _root_.openssl.functions.RAND_set_rand_engine
  export _root_.openssl.functions.RAND_set_rand_method
  export _root_.openssl.functions.RAND_set_seed_source_type
  export _root_.openssl.functions.RAND_status
  export _root_.openssl.functions.RAND_write_file
